...
type ClientNote struct {
	...
	// "kp" - typing notification, "call" - voice/video call, "react" - emoji reaction
...
const file_model_proto_rawDesc = "" +
	...
	"\breaction\x18\a \x01(\tR\breaction\"\x80\x01\n" +
	"\vClientExtra\x12 \n" +
	...
	"\breaction\x18\b \x01(\tR\breaction\"\xf3\x01\n" +
	"\tServerMsg\x12%\n" +
